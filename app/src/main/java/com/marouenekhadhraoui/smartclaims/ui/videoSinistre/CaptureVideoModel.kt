...
@HiltViewModel
class CaptureVideoModel @Inject constructor() : ViewModel(),
        LifecycleObserver {
    ...
    private val _pressBtnStopVideoEvent = MutableLiveData<Event<Unit>>()
    var pressBtnStopVideoEvent: LiveData<Event<Unit>> = _pressBtnStopVideoEvent
    ...
    fun stopVideo() {
        _pressBtnStopVideoEvent.value = Event(Unit)
    }
